...
<?php
    ...
    if(0==count($erro_array))
    {
        ...
        if(0!=count($erro_array)){
        header("Location:../donators_info.php?{$erro_array[0]}&{$erro_array[1]}&{$erro_array[2]}&{$erro_array[3]}&{$erro_array[4]}&{$erro_array[5]}&{$erro_array[6]}&{$erro_array[7]}");
        }
        else
        {
            if(checkmail($Email))
            {
                if(checkmobileNo($Mobile))
                {
                        ...
                        else
                        {
                            ...
                            header("Location:../donators_info.php?{$erro_array[6]}");   
                        }
                }
                else
                {
                    $erro_array[4]="mobile_erro=invalid";
                    header("Location:../donators_info.php?{$erro_array[4]}");
                }
            ...
            {
                $erro_array[2]="email_erro=invalid";
                header("Location:../donators_info.php?{$erro_array[2]}");
            } 
